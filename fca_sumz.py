...
def main():
    ...
    for entity_idx in range(1, 176):
        ...
        fo_top5 = open(output_filepath + str(entity_idx) + '_top5.nt', 'w')
        fo_top10 = open(output_filepath + str(entity_idx) + '_top10.nt', 'w')
        fo_rank = open(output_filepath + str(entity_idx) + '_rank.nt', 'w')
